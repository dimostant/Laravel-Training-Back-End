    ...
    <section class="bg-white dark:bg-gray-800">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4 font-medium">Deliver great service experiences fast - without the complexity of traditional democratic decisions. Accelerate critical development money gathering, eliminate "inconveniences", and deploy your night will with ease.</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-5">Welcome to the number one pavement installment company! Solid and concrete work for all your needs. Flexibility is our motto! We install concrete anywhere! Under bridges, inside lakes, inside houses, in basements, under construction tools. Don't believe us? Email our boss at EvagelakisMarinos@nightConstruction.com, and you won't believe your eyes!</p>
            </div>
