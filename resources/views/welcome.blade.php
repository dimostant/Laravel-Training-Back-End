            ...
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4" style="display: flex; justify-content: space-between;">
                        <span>Local</span>
                        <a href="https://github.com/themesberg/flowbite" class="hover:underline">+30 2421 566969</a>
                    </li>
                    <li style="display: flex; justify-content: space-between;">
                        <span>Cellphone</span>
                        <a href="https://discord.gg/4eeurUVvTy" class="hover:underline">+30 (695)-5556669</a>
                    </li>
                </ul>
            </div>
                <div>
